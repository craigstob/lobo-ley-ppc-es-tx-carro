...
<head>
    ...
    <style id="outermost-icon-block-style-inline-css">.wp-block-outermost-icon-block {
            display: flex;
            line-height: 0
        }
...
<script id="gform_gravityforms-js-extra">var gf_global = {
    gf_currency_config: {
      name: 'U.S. Dollar',
      symbol_left: '$',
      symbol_right: '',
  ...
  }), gf_legacy_multi = { 1: '' }, gform_gravityforms = {
    strings: {
...
<script id="wfi18njs-js-extra">var WordfenceI18nStrings = {
...
<script>gform.initializeOnLoaded(function () {jQuery(document).on('gform_post_render', function (o, n, i) {}), jQuery(document).on('gform_post_conditional_logic', function (o, n, i, t) {});});</script>
<script>gform.initializeOnLoaded(function () {
    jQuery(document).trigger('gform_pre_post_render', [{
      formId: '1',
      currentPage: '1',
